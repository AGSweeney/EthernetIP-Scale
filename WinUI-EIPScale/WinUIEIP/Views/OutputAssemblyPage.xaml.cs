...
public sealed partial class OutputAssemblyPage : Page
{
    ...
    public OutputAssemblyPage()
    {
        this.InitializeComponent();
        this.NavigationCacheMode = Microsoft.UI.Xaml.Navigation.NavigationCacheMode.Enabled;
        Loaded += OutputAssemblyPage_Loaded;
        Unloaded += OutputAssemblyPage_Unloaded;
    }
    ...
    private void OutputAssemblyPage_Loaded(object sender, RoutedEventArgs e)
    {
        UpdateConnectionState();
    ...
    public void UpdateConnectionState()
    {
        ...
        AssemblyContentBorder.Visibility = isConnected 
            ? Microsoft.UI.Xaml.Visibility.Visible 
            : Microsoft.UI.Xaml.Visibility.Collapsed;
        AssemblySizesPanel.Visibility = Microsoft.UI.Xaml.Visibility.Collapsed;
    }

    private void OutputAssemblyPage_Unloaded(object sender, RoutedEventArgs e)
    {
        _updateTimer?.Stop();
    }
    ...
    private async void UpdateTimer_Tick(object? sender, object? e)
    {
        ...
        try
        {
            ...
            if (assemblies?.OutputAssembly150?.RawBytes != null)
            {
                var bytes = assemblies.OutputAssembly150.RawBytes;
        ...
        {
            System.Diagnostics.Debug.WriteLine($"OutputAssemblyPage error: {ex}");
        }
        finally
        {
            _isUpdating = false;
